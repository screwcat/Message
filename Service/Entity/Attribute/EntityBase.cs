                ...
                for (int i = 0; i < propertyInfos.Length; i++)
                {
                    ...
                    if (propertyInfos[i].GetCustomAttributes(true)[0].GetType().Name != "PrimaryKeyAttribute")
                    {
                        if (((PropertyAttribute)(propertyInfos[i].GetCustomAttributes(true)[0])).ColumnName == string.Empty)
                        {
                            ...
                            {
                                case "Int32": propertyInfos[i].SetValue(this, Convert.ToInt32(dt.Rows[0][propertyInfos[i].Name]), null);
                                    break;
                                case "DateTime":
                                ...
                                case "Boolean":
                                    ...
                                    break;
                                default: propertyInfos[i].SetValue(this, dt.Rows[0][propertyInfos[i].Name].ToString(), null);
                                    break;
                            }
                        }
                        else
